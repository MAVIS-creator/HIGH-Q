...
$tests = [
    ...
    ['name' => 'tutors_page', 'method' => 'GET', 'url' => $base . '/index.php?pages=tutors'],
    ['name' => 'courses_page', 'method' => 'GET', 'url' => $base . '/index.php?pages=courses'],
    ['name' => 'users_page', 'method' => 'GET', 'url' => $base . '/index.php?pages=users'],
