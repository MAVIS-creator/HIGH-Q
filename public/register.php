													...
													<div class="section-body">
																									...
																									<div class="form-row">
																										...
																										<div id="postUtmeFields" style="display:none;margin-top:12px;padding:12px;border-radius:6px;background:#fff;border:1px solid #f0f0f0">
																											...
																											<div class="form-row"><label>JAMB Subjects & Scores (Optional)</label><textarea name="jamb_subjects_text" placeholder="ENG:70, MTH:65, ..."><?= htmlspecialchars($_POST['jamb_subjects_text'] ?? '') ?></textarea></div>
																											<hr>
