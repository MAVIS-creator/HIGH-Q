...
<!-- Debug: page-specific registration CSS (internal) -->
<style>
/* =======================
	 Root Colors
======================= */
:root {
	...
	--hq-white: #e9e8e5;
	--hq-gray-dark: #171717;
	--hq-blue-white: #575897;
	--hq-yellow-pale: #FFF6D9;
}
...
.register-main .card {
	background: #fff;
	border-radius: 10px;
	box-shadow: 0 4px 10px rgba(23, 23, 22, 0.1);
	padding: 2rem;
}
...
.register-main h3 span,
.register-main h3 strong {
	color: var(--hq-yellow);
}
...
.section-title {
	...
	font-size: 1.1rem;
	font-weight: 700;
	border-bottom: 2px solid var(--hq-yellow);
...
select:focus {
	...
	box-shadow: 0 0 0 2px var(--hq-yellow-pale);
}
...
.sidebar-card {
	...
	border-radius: 10px;
	padding: 1.5rem;
	box-shadow: 0 4px 8px rgba(23, 23, 22, 0.05);
}
