													...
													<div class="section-body">
																									...
																									<div class="form-row">
																										...
																										<div id="postUtmeFields" style="display:none;margin-top:12px;padding:12px;border-radius:6px;background:#fff;border:1px solid #f0f0f0">
																											...
																											<div class="form-row form-inline"><div><label>Subject 2</label><input type="text" name="jamb_subj_2" value="Mathematics" readonly></div><div><label>Score 2</label><input type="number" name="jamb_score_2" value="<?= htmlspecialchars($_POST['jamb_score_2'] ?? '') ?>"></div></div>
