...
<footer class="site-footer">
  ...
  <img src="<?= app_url('assets/images/hq-logo.jpeg') ?>" alt="HQ Logo" class="brand-logo">
      ...
      <!-- NYSC Accreditation in Footer -->
      <div class="footer-nysc-badge">
        <img src="<?= app_url('assets/images/nysc-logo.png') ?>" alt="NYSC Logo" class="footer-nysc-logo" onerror="this.style.display='none'">
        <div class="footer-nysc-text">
          <strong>NYSC Accredited Centre</strong>
          <span>Official Skills Acquisition Partner</span>
        </div>
      </div>
  ...
  <div class="footer-bottom">
    <p>© <?= date('Y') ?> High Q Solid Academy Limited. All rights reserved.</p>
      ...
      <a href="https://github.com/MAVIS-creator" target="_blank" rel="noopener noreferrer" class="credit-mavis" style="background:linear-gradient(90deg,#ffd54f,#3b82f6);-webkit-background-clip:text;background-clip:text;-webkit-text-fill-color:transparent;font-weight:800;font-size:0.95rem;letter-spacing:.02em;text-decoration:none;transition:opacity 0.2s;" onmouseover="this.style.opacity='0.8'" onmouseout="this.style.opacity='1'">Made by MAVIS</a>
      <span style="color:#94a3b8;">•</span>
      <a href="https://github.com/gamerdave-web" target="_blank" rel="noopener noreferrer" class="credit-gamerdave" style="color:#ffd54f;font-weight:800;font-size:0.95rem;text-decoration:none;transition:color 0.2s;" onmouseover="this.style.color='#3b82f6'" onmouseout="this.style.color='#ffd54f'">Exam portal made by gamerdave</a>
    </div>
    <div class="links">
