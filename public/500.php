...
<body class="bg-gradient-to-br from-red-50 to-orange-100 min-h-screen flex items-center justify-center p-4">
    <div class="max-w-2xl w-full">
        <!-- React TSX-style Component -->
        <div class="bg-white rounded-2xl shadow-2xl p-8 md:p-12 text-center">
            <!-- Icon -->
            <div class="flex justify-center mb-6">
                <div class="pulse-slow bg-gradient-to-br from-orange-500 to-red-600 text-white rounded-full w-24 h-24 flex items-center justify-center shadow-lg">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="./index.php" 
                   class="inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-orange-600 to-red-600 text-white font-semibold rounded-lg hover:from-orange-700 hover:to-red-700 transition-all duration-200 shadow-lg hover:shadow-xl">
