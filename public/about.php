...
<section class="about-hero">
  ...
  <div class="container about-hero-inner text-center text-md-start">
  ...
  <div class="container">
    <div class="row align-items-start">
      <div class="col-12 col-md-8">
        <h3 class="mb-4">History About High Q Solid Academy</h3>

        <div class="history-logo float-md-end float-sm-none ms-md-3 mb-3 text-center text-md-start">
          <img src="./assets/images/hq-logo.jpeg" alt="HQ Logo" class="img-fluid rounded" style="max-width: 120px;">
        </div>
      ...
      <div class="col-12 col-md-4 text-center text-md-start mt-4 mt-md-0">
        <div class="logo-card p-3 bg-white rounded shadow-sm d-inline-block">
          <img src="./assets/images/hq-logo.jpeg" alt="HQ Logo" class="img-fluid" style="max-width: 140px;">
        </div>
      </div>
    </div>
  </div>
...
<section class="values-section py-5">
  <div class="container">
    <div class="row g-4">
      <article class="value-card col-12 col-md-6">
    ...
    <div class="ceo-heading text-center my-5">
      <h2>Our Core <span class="highlight">Values</span></h2>
    </div>

    <div class="core-grid row row-cols-2 row-cols-md-3 g-4">
      <div class="core-value-card col">
