  ...
  if (!$s) {
    ...
    echo json_encode([
      ...
      'data' => [
        ...
        'surname'                => $p['surname'] ?? ($p['last_name'] ?? null),
        ...
        'email'                  => $p['email'] ?? null,
        'nin_number'             => $p['nin_number'] ?? null,
        'local_government'       => $p['local_government'] ?? null,
        'place_of_birth'         => $p['place_of_birth'] ?? null,
        'nationality'            => $p['nationality'] ?? null,
        'mode_of_entry'          => $p['mode_of_entry'] ?? null,
        'state_of_origin'        => $p['state_of_origin'] ?? null,
        'marital_status'         => $p['marital_status'] ?? null,
        'disability'             => $p['disability'] ?? null,
        'religion'               => $p['religion'] ?? null,
        // jamb
        'jamb_registration_number'=> $p['jamb_registration_number'] ?? null,
        'jamb_score'             => $p['jamb_score'] ?? null,
        'jamb_subjects'          => $p['jamb_subjects'] ?? null,
        // course & institution choices
        'course_first_choice'    => $p['course_first_choice'] ?? null,
        'course_second_choice'   => $p['course_second_choice'] ?? null,
        'institution_first_choice'=> $p['institution_first_choice'] ?? null,
        // parent details
        'father_name'            => $p['father_name'] ?? null,
        'father_phone'           => $p['father_phone'] ?? null,
        'father_email'           => $p['father_email'] ?? null,
        'father_occupation'      => $p['father_occupation'] ?? null,
        'mother_name'            => $p['mother_name'] ?? null,
        'mother_phone'           => $p['mother_phone'] ?? null,
        'mother_occupation'      => $p['mother_occupation'] ?? null,
        // education history
        'primary_school'         => $p['primary_school'] ?? null,
        'primary_year_ended'     => $p['primary_year_ended'] ?? null,
        'secondary_school'       => $p['secondary_school'] ?? null,
        'secondary_year_ended'   => $p['secondary_year_ended'] ?? null,
        // sponsor & next of kin
        'sponsor_name'           => $p['sponsor_name'] ?? null,
        'sponsor_address'        => $p['sponsor_address'] ?? null,
        'sponsor_email'          => $p['sponsor_email'] ?? null,
        'sponsor_relationship'   => $p['sponsor_relationship'] ?? null,
        'sponsor_phone'          => $p['sponsor_phone'] ?? null,
        'next_of_kin_name'       => $p['next_of_kin_name'] ?? null,
        'next_of_kin_address'    => $p['next_of_kin_address'] ?? null,
        'next_of_kin_email'      => $p['next_of_kin_email'] ?? null,
        'next_of_kin_relationship'=> $p['next_of_kin_relationship'] ?? null,
        'next_of_kin_phone'      => $p['next_of_kin_phone'] ?? null,
        // olevel/exam
        'exam_type'              => $p['exam_type'] ?? null,
        'candidate_name'         => $p['candidate_name'] ?? null,
        'exam_number'            => $p['exam_number'] ?? null,
        'exam_year_month'        => $p['exam_year_month'] ?? null,
        'olevel_results'         => $p['olevel_results'] ?? null,
        'waec_token'             => $p['waec_token'] ?? null,
        'waec_serial'            => $p['waec_serial'] ?? null,
        'passport_photo'         => $p['passport_photo'] ?? $p['passport_path'] ?? null,
        // system
        'payment_status'         => $p['payment_status'] ?? null,
        'form_fee_paid'          => $p['form_fee_paid'] ?? null,
        'tutor_fee_paid'         => $p['tutor_fee_paid'] ?? null,
