...
<div class="roles-page">
  ...
  <td class="actions-col">
          ...
          <form method="post" action="<?= admin_url('index.php?pages=roles.php&action=delete&id=' . $r['id']) ?>" style="display:inline">
...
<div class="modal" id="roleModal" aria-hidden="true">
  ...
  <form id="roleForm" method="post" action="<?= admin_url('index.php?pages=roles.php&action=create') ?>">
      <!-- CSRF token -->
