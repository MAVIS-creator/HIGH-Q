...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_GET['action'])) {
  ...
  header("Location: /HIGH-Q/admin/pages/roles.php");
  exit;
}
...
function openModal(mode, role = {}) {
  ...
  roleForm.action = `/HIGH-Q/admin/pages/roles.php?action=edit&id=${role.id}`;
  ...
  roleForm.action = '/HIGH-Q/admin/pages/roles.php?action=create';
    nameInput.value = '';
    slugInput.value = '';
    maxInput.value  = '';
  }
...
document.querySelector('table.roles-table').addEventListener('click', function(e){
  ...
  var xhr = new XMLHttpRequest(); xhr.open('POST','/HIGH-Q/admin/pages/roles.php?action=delete&id='+encodeURIComponent(id), true); xhr.setRequestHeader('X-Requested-With','XMLHttpRequest');
