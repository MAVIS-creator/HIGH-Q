<?php
// admin/pages/appointments.php - content only; header/sidebar handled by pages/index.php
        ...
        if ($action === 'update_status') {
            ...
            if ($appointment) {
                ...
                if ($newStatus === 'confirmed') {
                    ...
                    $message .= "<p>Your visit to High Q Solid Academy has been <strong>confirmed</strong>.</p>";
                    ...
                    $message .= "<p>Dear " . htmlspecialchars($appointment['name']) . ",</p>";
                    $message .= "<p>We are unable to accommodate your requested appointment on " . date('F j, Y', strtotime($appointment['visit_date'])) . " at " . date('g:i A', strtotime($appointment['visit_time'])) . ".</p>";
